...
function TodoItem(prop){
 ...
 <div className='flex  items-center mt-2  rounded-md p-2 bg-purple-300   mx-4'>
     ...
     {prop.list.ismark ? <FaSmile className=' text-green-500 size-6 align-middle '></FaSmile> :<FaSadTear className=' text-red-500 size-6 align-middle '></FaSadTear>}
  ...
  <FaTrash className='size-6 m-2 text-red-800 cursor-pointer ' onClick={()=>{
